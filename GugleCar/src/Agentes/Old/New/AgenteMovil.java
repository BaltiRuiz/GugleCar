...
public class AgenteMovil extends Agente {
    ...
    @Override
    public void execute() {
        Conflictos conflictos = new Conflictos();
        int contador_movimientos_terminados = 0;
        try {
            ...
            while (!exit) {
                ...
                Mensajes estado = Mensajes.toEstado(msg);
                imprimir("Agente " + this.getName() + " entrando a case " + estado);
    ...
    private enum Mensajes{
        ...
        public static Mensajes toEstado(ACLMessage msg){
            ...
            if (msg_content.contains("battery") && msg_content.contains("energy")
                ...
                return Mensajes.SIGUIENTE_MOVIMIENTO;
